    ...
    class BlightedThorn : ModProjectile
    {
        ...
        public override bool PreDrawExtras()
        {
            if (AIState == 3)
            {
                ...
                DrawHelper.DrawLaser(tex, Projectile.Center, new Vector2(0, 1).RotatedBy(Projectile.rotation), 10, new Rectangle(0, 0, 28, 26), new Rectangle(0, 26, 28, 26), new Rectangle(0, 52, 28, 26), MathHelper.PiOver2, 1, 2000, Color.White, 50, 2000);
            }
            return true;
        }
