...
{
    class ShadowSummon : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            {
                target.AddBuff(BuffType<Buffs.ConsumingDark>(), 120, true);
        ...
        public override void AI()
        {
            ...
            if (foundTarget)
            {
                ...
                if (distanceFromTarget > 70f && attackCool <= 0)
                {
            ...
            if (shadow > 0)
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustType<Dusts.Shadow>(), Projectile.velocity.X, Projectile.velocity.Y);
                shadow--;
            }
