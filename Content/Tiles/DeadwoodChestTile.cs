...
namespace ExoriumMod.Content.Tiles
{
    class DeadwoodChestTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Deadwood Chest";
                if (player.cursorItemIconText == "Deadwood Chest")
                {
                    player.cursorItemIconID = ItemType<Items.TileItems.DeadwoodChest>();
                }
            }
            player.noThrow = 2;
