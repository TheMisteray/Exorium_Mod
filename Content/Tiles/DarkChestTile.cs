...
namespace ExoriumMod.Content.Tiles
{
    class DarkChestTile : ModTile
    {
        ...
        public override void MouseOver(int i, int j)
        {
            ...
            {
                player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Dark Chest";
                if (player.cursorItemIconText == "Dark Chest")
                {
                    player.cursorItemIconID = ItemType<Items.TileItems.StructureTileItems.ShadowmancerTileItems.DarkChest>();
                    if (Main.tile[left, top].TileFrameX / 36 == 1)
                        player.cursorItemIconID = ItemType<Items.Misc.DarkKey>();
